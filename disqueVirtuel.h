...
private:
	...
	bool bd_doesRepoExist(const std::string& p_DirName); // Vérifie si une string de répertoire est associée à une i-node
	int createEmptyRepo(); // Crée un répertoire vide contenant les entrées "." et ".."
